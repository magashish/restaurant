                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="header_top_left">
                            ...
                            <div class="phone"><a href="tel:1234567890"><i class="fas fa-phone-alt"></i> (123) 456 7890</a></div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="header_top_right">
						 @guest
                            <div class="login"><a href="{{route('login')}}"><i class="fas fa-sign-in-alt"></i> {{ __('Login') }}</a></div>
							 @if (Route::has('register'))
                            <div class="signup"><a href="{{route('register')}}"><i class="far fa-edit"></i> {{ __('Sign Up') }}</a></div>
						    @endif
						 @else 
                             <div class="login"><a href="{{route('login')}}"><i class="fas fa-sign-in-alt"></i> {{ __('Login') }}</a></div>
						     <div class="signup"><a href="{{ route('logout') }}"   onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();"><i class="far fa-edit"></i> {{ __('Logout') }}</a></div>
