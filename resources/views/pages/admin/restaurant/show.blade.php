				...
				<form action="{{ route('restaurant.store') }}" method="POST" enctype="multipart/form-data">
				   @csrf        
					...
					<div class="form-group">
						...
						<textarea class="form-control" id="sdesc" rows="3" name="shortdescription">{{$data['shortdescription']}}</textarea>
					</div>
					<div class="form-group">
						<label for="desc">Description</label>
						<textarea class="form-control" id="desc" rows="3" name="description">{{$data['description']}}</textarea>
					</div>
