				...
				<form action="{{ route('restaurantmenuadd') }}" method="POST" enctype="multipart/form-data">
				   @csrf        
					<div class="form-group">
						...
						<input class="form-control" type="hidden" id="restaurant_id" value="{{$id}}" name="restaurant_id">
					...
					<div class="table-responsive">  
						<table class="table table-bordered" id="dynamic_field">  
							<tr>  
								<td width="35%"><input type="text" name="itemoption[]" placeholder="Enter Options" class="form-control name_list"/></td>
