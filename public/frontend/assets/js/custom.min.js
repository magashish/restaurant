jQuery(window).on("load", function() {
    ...
    jQuery('body').attr('data-sidebar-style') === "mini" ? $(".hamburger").addClass('is-active') : $(".hamburger").removeClass('is-active')
});
...
//     $('.sidebar').css({"display": "block", "overflow": "inherit" });
//     $("#accordionSidebar").addClass("Mobilewidth");
